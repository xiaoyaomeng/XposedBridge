 ...
 * In that case, XTAS will extend the ROM's subclass in an attempt to increase
 * compatibility.
 */
public class XTAS extends TypedArray {
	/** Dummy, will never be called (objects are transferred to this class only). */
	protected XTAS(Resources resources, int[] data, int[] indices, int len) {
