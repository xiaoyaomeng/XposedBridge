...
/** @hide */
public final class BSa extends SBa {
	 ...
	 */
	public static BSa getService(int target) {
		...
		synchronized (sServices) {
			if (sServices[target] == null) {
				sServices[target] = new BSa(target);
			}
	...
	@Override
	public SBb readFile(String filename, int offset, int length,
	...
	// ----------------------------------------------------------------------------
	private static final String INTERFACE_TOKEN = "com.google.android.messaging.mservice";
