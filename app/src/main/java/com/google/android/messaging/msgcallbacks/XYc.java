 ...
 */
public abstract class XYc implements Comparable<XYc> {
	/**
	...
	public static abstract class Param {
		...
		/** @hide */
		protected Param(CopyOnWriteSortedSet<? extends XYc> callbacks) {
	...
	public static void callAll(Param param) {
		...
		for (int i = 0; i < param.callbacks.length; i++) {
			try {
				((XYc) param.callbacks[i]).call(param);
	...
	/** @hide */
	@Override
	public int compareTo(XYc other) {
		if (this == other)
			return 0;
