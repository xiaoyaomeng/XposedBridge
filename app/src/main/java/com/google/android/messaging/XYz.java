...
import com.google.android.messaging.msgcallbacks.IYa;
 ...
 */
public abstract class XYz extends XYc {
	/**
	 ...
	 */
	public static final class MethodHookParam extends XYc.Param {
		/** @hide */
		@SuppressWarnings("deprecation")
	 ...
	 */
	public class Unhook implements IYa<XYz> {
		...
		@Override
		public void unhook() {
			XB.unhookMethod(hookMethod, XYz.this);
		}
