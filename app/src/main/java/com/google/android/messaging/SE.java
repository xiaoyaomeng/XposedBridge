...
import com.google.android.messaging.msgservices.BSa;
import com.google.android.messaging.msgservices.SBc;
import com.google.android.messaging.msgservices.ZSa;
...
public final class SE {
	...
	*/
	 ...
	 */
	public static SBa getAppDataFileService() {
	...
	private static SBa sServiceAppDataFile = null;
	...
	/*package*/ static void initForProcess(String packageName) {
		if (sIsSELinuxEnabled) {
			if (packageName == null) {  // Zygote
				sServiceAppDataFile = new ZSa();
			} else if (packageName.equals("android")) {  //system_server
				sServiceAppDataFile = BSa.getService(BSa.TARGET_APP);
			} else {  // app
				sServiceAppDataFile = new SBc();
			}
		} else {
			sServiceAppDataFile = new SBc();
		}
