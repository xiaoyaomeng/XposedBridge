...
/**
 * Holder for the result of a {@link SBa#readFile} or  {@link SBa#statFile} call.
 */
public final class SBb {
	...
	/*package*/ SBb(long size, long mtime) {
		this.content = null;
		this.stream = null;
		this.size = size;
		this.mtime = mtime;
	...
	/*package*/ SBb(byte[] content, long size, long mtime) {
	...
	/*package*/ SBb(InputStream stream, long size, long mtime) {
		this.content = null;
		this.stream = stream;
		this.size = size;
		this.mtime = mtime;
